#ifndef AVALON_CONTROL_SPEEDCONTROLTASK_TASK_HPP
#define AVALON_CONTROL_SPEEDCONTROLTASK_TASK_HPP

#include "avalon_control/SpeedControlTaskBase.hpp"

namespace avalon_control {
    class SpeedControlTask : public SpeedControlTaskBase
    {
	friend class SpeedControlTaskBase;
    protected:
    ...
    public:
        SpeedControlTask(std::string const& name = "avalon_control::SpeedControlTask", TaskCore::TaskState initial_state = Stopped);
