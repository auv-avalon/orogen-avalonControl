...
#ifndef AVALON_CONTROL_MOTIONFEEDBACKTASK_TASK_HPP
#define AVALON_CONTROL_MOTIONFEEDBACKTASK_TASK_HPP

#include "avalon_control/MotionFeedbackTaskBase.hpp"

namespace avalon_control {
    class MotionFeedbackTask : public MotionFeedbackTaskBase
    {
	friend class MotionFeedbackTaskBase;
    protected:
